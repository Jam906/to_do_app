...
define('THUMBLIB_PLUGIN_PATH', THUMBLIB_BASE_PATH . '/ThumbLib.inc/');
define('DEFAULT_THUMBLIB_IMPLEMENTATION', 'gd');

/**
 * Include the PhpThumb Class
 */
require_once THUMBLIB_PLUGIN_PATH. '/PhpThumb.inc.php';
/**
 * Include the ThumbBase Class
 */
require_once THUMBLIB_PLUGIN_PATH . '/ThumbBase.inc.php';
/**
 * Include the GdThumb Class
 */
require_once THUMBLIB_PLUGIN_PATH . '/GdThumb.inc.php';
